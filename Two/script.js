...
for (var i = 0; i < selectMonths.length; ++i) {
    ...
    dropdownMonth[dropdownMonth.length] = new Option(selectMonths[i], selectMonths[i]);
}
...
const c = setInterval(() => {
   ...
   // console.log(currentDate)
    ...
    countDown.textContent =`${days}days ${hours}hrs : ${minutes}min : ${seconds}s` + " for your next b-day";
    if(totalSeconds < 0 ){
        clearInterval(c);
